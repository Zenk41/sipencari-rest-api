...
type ComReactionRepository interface {
	...
	Update(reaction models.CommentReaction) (models.CommentReaction, error)
...
func (crr *comReactionRepository) Update(reaction models.CommentReaction) (models.CommentReaction, error) {
	err := crr.conn.Preload("User").Updates(&reaction).Error
	return reaction, err
}
